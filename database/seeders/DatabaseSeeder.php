...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $this->call(SubjectsTableSeeder::class); // Disabled dummy data
        // $this->call(SectionsTableSeeder::class); // Disabled dummy data
        // $this->call(StudentRecordsTableSeeder::class); // Disabled dummy data
